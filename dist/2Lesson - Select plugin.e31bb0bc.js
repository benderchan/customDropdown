...
var getTemplate = function getTemplate() {
  ...
  var text = placeholder !== null && placeholder !== void 0 ? placeholder : 'Default text';
  var items = data.map(function (el) {
    ...
    return "<li class='select__item ".concat(classes, "' data-type='li' data-id='").concat(el.id, "'>").concat(el.value, "</li>");
  });
...
var Select = /*#__PURE__*/function () {
  ...
  _createClass(Select, [{
    ...
    value: function select(id) {
      this.selectedId = id;
      this.$value.textContent = this.options.data[this.selectedId - 1].value; // this.$value.textContent = this.currentEl.value

      this.el.querySelectorAll('[data-type="li"]').forEach(function (el) {
...
//# sourceMappingURL=/2Lesson%20-%20Select%20plugin.e31bb0bc.js.map